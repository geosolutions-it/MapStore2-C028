...
const isMobile = (state) => state && state.browser && state.browser.mobile || false;
...
module.exports = {
    CreateNewMapPlugin: connect((state) => ({
        ...
        isLoggedIn: state && state.security && state.security.user && state.security.user.enabled && !isMobile(state) && true || false,
