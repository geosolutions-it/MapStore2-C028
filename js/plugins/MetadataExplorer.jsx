...
const {textSearch, changeCatalogFormat, addLayer, addLayerError, resetCatalog} = require("../../MapStore2/web/client/actions/catalog");
...
class MetadataExplorerComponent extends React.Component {
    ...
    render() {
        const panel = <div role="body" className="modal_window"><Catalog recordItem={RecordItem} zoomToLayer={this.props.zoomToLayer} searchOnStartup={this.props.searchOnStartup} active={this.props.active} {...this.props}/></div>;
        if (this.props.wrap) {
